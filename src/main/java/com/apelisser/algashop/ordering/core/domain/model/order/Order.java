...
import com.apelisser.algashop.ordering.core.domain.model.AbstractEventSourceEntity;
import com.apelisser.algashop.ordering.core.domain.model.AggregateRoot;
...
public class Order extends AbstractEventSourceEntity implements AggregateRoot<OrderId> {
    ...
    public void place() {
        ...
        this.publishDomainEvent(new OrderPlacedEvent(
            this.id(),
            this.customerId(),
            this.placedAt())
        );
    ...
    public void markAsPaid() {
        ...
        this.publishDomainEvent(new OrderPaidEvent(
            this.id(),
            this.customerId(),
            this.paidAt())
        );
    ...
    public void markAsReady() {
        ...
        this.publishDomainEvent(new OrderReadyEvent(
            this.id(),
            this.customerId(),
            this.readyAt())
        );
    ...
    public void cancel() {
        ...
        this.publishDomainEvent(new OrderCanceledEvent(
            this.id(),
            this.customerId(),
            this.canceledAt())
        );
    ...
    private void recalculateTotals() {
        ...
        BigDecimal shippingCost = this.shipping() == null
            ? BigDecimal.ZERO
            : this.shipping.cost().value();
