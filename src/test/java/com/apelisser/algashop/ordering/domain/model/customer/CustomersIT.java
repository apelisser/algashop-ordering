...
import com.apelisser.algashop.ordering.infrastructure.persistence.provider.CustomersPersistenceProvider;
...
class CustomersIT {
    ...
    public void shouldNotAllowStaleUpdates() {
        ...
        customerT2.changeName(new FullName("Fulano","Silva"));
    ...
    void shouldReturnIfEmailIsInUse() {
        ...
        Assertions.assertThat(customers.isEmailUnique(new Email("name@email.com"), new CustomerId())).isTrue();
    }
